...
- 杀手数独在题目生成、约束设置、难度梯度设置等方面需要复杂耗时的算法推导与数学计算，而这是ai的优势；
- 数独游戏页面简洁、逻辑简明、按键简易、功能简单，没有复杂的动画、模型、系统等高级需求，技术栈少而易，适合vibe coding入门练手；
- 网页端游戏制作难度较低，且适配多端，可以让用户不用多考虑相关技术如何使用，专心体验vibe coding流程；
- 我喜欢玩数独😋
